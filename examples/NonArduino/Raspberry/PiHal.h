...
//#define PI_RISING     (LG_FALLING_EDGE)
//#define PI_FALLING    (LG_RISING_EDGE)

// Simple shim macros for now
#define PI_INPUT  0
#define PI_OUTPUT 1
...
class PiHal : public RadioLibHal {
  public:
    ...
    PiHal(uint8_t gpioDevice, uint8_t spiDevice, uint8_t spiChannel, uint32_t spiSpeed = 2000000)
    ...
    unsigned long millis() override {
      return lguTimestamp() / 1000000;
    }

    unsigned long micros() override {
      return lguTimestamp() / 1000;
    }
